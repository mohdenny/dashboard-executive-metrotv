  ...
  return (
    ...
    <div className="bg-card md:px-6 px-4 md:py-4 py-3 border-border border rounded-xl flex lg:flex-row items-center justify-between shadow-sm">
      ...
      <div className="flex md:hidden flex-col gap-1 content-center">
        ...
        <span className="text-sm text-muted-foreground/60">{lastUpdated}</span>
      </div>
      ...
      <div className="md:flex items-center gap-4 hidden">
        ...
        <CustomSelect
          ...
          // List opsi kategori digabung sama opsi semua dan diurutin abjad
          options={[
            { label: "Semua", value: "" },
            ...[...programCategories]
          ...
          // Teks placeholder dinyalain lagi sesuai rikues
        ...
        <div className="hidden md:flex flex-row items-center gap-4">
          ...
          <div className="hidden md:flex flex-wrap items-center gap-3">
            ...
            {/* Kondisional buat tampilin tombol reset filter dikomentarin biar rapi */}
            {/*
              {(startMonth ||
                endMonth ||
                selectedCategory ||
                ...
                <div className="flex flex-col justify-around gap-4 overflow-y-auto p-2 ">
                  <div>
                    ...
                    >
                      ...
                      {/* Opsi semua */}
                      <option value="" className="bg-muted/40 text-foreground">
                        Semua
                      </option>
                      {/* Mapping kategori yang udah diurutin abjad */}
                      {[...programCategories]
                        .sort((a, b) => a.localeCompare(b))
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="bg-card border border-border rounded-lg flex flex-row items-stretch mt-2">
                      <div
                        className={`flex flex-1 justify-center items-center border-border border-right rounded-s-lg transition-all  px-2 py-2
                    ${PeriodValue === "all" ? "bg-background shadow-sm text-white" : "text-muted-foreground hover:text-foreground hover:bg-card/50"}`}
                      ...
                      <div
                        className={`flex flex-1 justify-center items-center transition-all  px-2 py-2
                    ...
                    ${PeriodValue === "30d" ? "bg-background shadow-sm text-white" : "text-muted-foreground hover:text-foreground hover:bg-card/50"}`}
                      ...
                      <div
                        className={`flex flex-1 justify-center items-center rounded-e-lg transition-all  px-2 py-2
                  ...
                  <div className="flex flex-row gap-2 mt-4">
                    <button
                      className="w-full h-10 bg-card border-border border rounded-md"
                      onClick={() => {
                        setEndMonthValue("");
                        setStartMonthValue("");
                        SetPeriodValue("");
                    ...
                    <button
                      className="w-full h-10 bg-white border-border border rounded-md"
                      onClick={() => {
